...
const TooltipProvider = ({
  delayDuration = 0,
  ...props
}: React.ComponentProps<typeof TooltipPrimitive.Provider>): (ReactNode | Promise<ReactNode>) => {
  return (
...
const TooltipTrigger = ({
  ...props
}: React.ComponentProps<typeof TooltipPrimitive.Trigger>): (ReactNode | Promise<ReactNode>) => {
...
const TooltipContent = ({
  ...
  children,
  ...props
}: React.ComponentProps<typeof TooltipPrimitive.Content>): (ReactNode | Promise<ReactNode>) => {
  return (
